...
<body class="bg-gray-50 text-gray-900 font-sans antialiased">
    {{-- Alert sukses --}}
    @if(session('success'))
<div class="alert alert-success alert-dismissible fade show position-fixed  start-50 translate-middle-x shadow-sm px-3 py-2 small d-flex align-items-center gap-2  mt-4" role="alert" style="top: 50px; z-index: 1050; min-width: 250px;">
...
@if(session('error'))
<div class="alert alert-danger alert-dismissible fade show position-fixed  start-50 translate-middle-x  shadow-sm px-3 py-2 small d-flex align-items-center gap-2  mt-4" role="alert" style="top: 50px; z-index: 1050; min-width: 250px;">
